...
namespace NNSimulator {
    ...
    /*! \~russian \brief Класс решателя для универсальных процессоров.
     * \details Включает в себя различные реализации моделей симуляторов.
     */
    template<class T> class SolverImplCPU : public SolverImpl<T> {

        public:
            //! \~russian \brief Реализация модели Е.М. Ижикевича (2003) методом Эйлера.
            ...
            /*! \~russian
             * \brief Реализация модели UNN270117 методом Рунге-Кутты 4 5.
             *
