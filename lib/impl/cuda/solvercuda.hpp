...
namespace NNSimulator {
    ...
    //! \~russian \brief Реализации решателей на графическом процессоре.
    template<class T> class SolverImplCuda : public SolverImpl<T> {
    public:

        //! \~russian \brief Реализация модели Е.М. Ижикевича (2003) на GPU.
        ...
        /*! \~russian
         * \brief Реализация модели UNN270117 методом Рунге-Кутты 4 5 на GPU.
         *
